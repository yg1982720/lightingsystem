package com.zklink.lightingsystem.location.view;
...
public class CustomGroup extends ViewGroup {
	...
	private CustomAboveView.CustomAboveViewClickListener mCustomAboveViewClickListener;
	...
	private ArrayList<DragIconInfo> initAllOriginalInfo() {
		...
		if(mdbManager!=null) {
			infoList = mdbManager.searchAllGroupData();
	...
	public void setgroupinfodb(DBManager dbManager)
	{
